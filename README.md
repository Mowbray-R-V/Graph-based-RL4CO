...
1. [The Principles of Diffusion Models](https://arxiv.org/pdf/2510.21890)      
...
27. LeJEPA: Provable and Scalable Self-Supervised Learning Without the Heuristics (Meta AI, LeCun Lab, 2025) **(demonstrates that enforcing an isotropic-Gaussian latent geometry yields mathematically provable stability in self-supervised learning, removing the need for heuristics and outperforming existing large-scale SSL models.)**
